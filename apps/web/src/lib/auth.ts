...
/**
 * มีคุกกี้เซสชันติดมาด้วยหรือไม่ — **ไม่ได้แปลว่าเซสชันยังใช้ได้**
 *
 * ใช้ที่เดียวคือหน้า `/` เพื่อแยกว่าคนที่เปิดเข้ามาเป็นผู้เข้าชมที่ยังไม่เคยใช้ระบบ
 * (ไม่มีคุกกี้เลย → แสดงหน้าแนะนำระบบ) หรือเป็นผู้ใช้ที่กลับมา (→ requireSession ตามเดิม)
 *
 * ที่ต้องดูแค่คุกกี้เพราะหน้าแนะนำระบบต้องเปิดได้โดยไม่แตะฐานข้อมูลเลย
 * คนที่ยังไม่ได้เป็นลูกค้าและบ็อตของเครื่องมือค้นหาไม่ควรสร้าง query ให้ฐาน
 * และหน้านั้นไม่ควรล่มตามฐานข้อมูล · คุกกี้ที่หมดอายุแล้วยังเด้งไปหน้าล็อกอินเหมือนเดิม
 *
 * **ห้ามเอาไปใช้ตัดสินสิทธิ์อะไรทั้งสิ้น** — ค่านี้ผู้ใช้ปลอมได้เองจากเบราว์เซอร์
 */
