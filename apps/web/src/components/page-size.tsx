 ...
 *
 * ทุกรายการที่แบ่งหน้าได้เปิดมาหน้าละ 10 (ผู้ใช้กำหนด 17 ก.ย. 2569) — ทะเบียนลูกค้า/ผู้ขาย
 * และเอกสารขายในหน้ายอดขายเดิมใช้ชุดของรุ่น 3.6 (5 / 20 / 50 ตั้งต้น 20) ตอนนี้ใช้ชุดเดียวกับหน้าประวัติ
 */
