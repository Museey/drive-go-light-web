...
export function ScanBox({ onScan }: {
   ...
   */
  /* preventScroll: ช่องนี้อยู่กลางฟอร์ม โฟกัสตอนเปิดหน้าทำให้เบราว์เซอร์เลื่อนหน้าลงไปหา
     ผู้ใช้เปิดมาไม่เห็นหัวเอกสาร (ผู้ใช้แจ้ง 16 ก.ย. 2569) — ยังยิงได้ทันทีเหมือนเดิม แค่ไม่เลื่อนหน้า */
  useEffect(() => { ref.current?.focus({ preventScroll: true }); }, [pending]);
