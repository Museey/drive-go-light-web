...
/**
 * หกช่องของแถบล่าง — มือถือและแท็บเล็ต
 *
 * ห้าช่องแรกคือเมนูที่ใช้บ่อยที่สุดของหน้าเคาน์เตอร์ ช่องที่หกเปิดลิ้นชักที่มีเมนูครบ
 * **ไม่ใช่เมนูที่ถูกตัดทิ้ง** — ทุกเมนูยังไปถึงได้เสมอจากช่องเพิ่มเติม
 *
 * ลำดับตามต้นแบบของทีม (16 ก.ย. 2569): หน้าแรก · ลูกค้า · รายรับ · สินค้า · รายจ่าย · เพิ่มเติม
 * (เดิมสี่ช่อง ไม่มีรายจ่าย — ต้นแบบถือว่าจดรายจ่ายเป็นงานประจำวันของอู่พอ ๆ กับออกใบเสร็จ)
 * ดู docs/ui-layout-spec.md §5.1
 */
export const TAB_KEYS = ['home', 'customer', 'income', 'stock', 'expense'] as const;

/** ชื่อสั้นบนแถบล่าง — ชื่อเต็มในผังเมนูยาวเกินช่องกว้างหนึ่งในห้าของจอ */
