 ...
 *
 * สี่ช่องแรกคือเมนูที่ใช้บ่อยที่สุดของหน้าเคาน์เตอร์ ช่องที่ห้าเปิดลิ้นชักที่มีเมนูครบ
 * **ไม่ใช่เมนูที่ถูกตัดทิ้ง** — ทุกเมนูยังไปถึงได้เสมอจากช่องเพิ่มเติม
 *
 * ตามสเปกหน้าจอ docs/ui-layout-spec.md §5.1: หน้าแรก · รายรับ · สินค้า · ลูกค้า · เพิ่มเติม
 * (เดิมเป็นรายจ่ายแทนลูกค้า — สเปกใหม่ถือว่าหน้าเคาน์เตอร์ค้นลูกค้าบ่อยกว่าบันทึกรายจ่าย)
 */
export const TAB_KEYS = ['home', 'income', 'stock', 'customer'] as const;
