...
- เมนู 06 บัญชี/การเงิน — ครบทั้งสี่แท็บ พิมพ์รายงานได้ แต่ยังส่งออกเป็น CSV ไม่ได้

- เมนู 03 รายรับ — ออกเอกสารครบสาย ใบเสนอราคา → ใบส่งมอบ → ใบเสร็จ แก้ไข ยกเลิก และพิมพ์ได้แล้ว
- เมนู 05 สินค้า — ยังซ่อนคอลัมน์ในตารางไม่ได้ (ของเดิมทำได้)
- ยังไม่ส่งอีเมลเอง — ลิงก์ตั้งรหัสผ่านต้องคัดลอกส่งให้พนักงานเอง
  และผู้ใช้ยังกด "ลืมรหัสผ่าน" ด้วยตัวเองไม่ได้ ต้องให้เจ้าของกิจการออกลิงก์ให้
- ยังสร้าง/แก้เอกสารไม่ได้ · ยังพิมพ์ไม่ได้
- ตาราง `vat_periods` สำหรับปิดงวด ภ.พ.30 — ตอนนี้เครดิตยกยอดคำนวณสดจากเอกสารทั้งหมด
  เหมือนโปรแกรมเดิม ยังไม่มีการล็อกงวดที่ยื่นภาษีไปแล้ว
